...
if __name__ == "__main__":
	...
	connect={}
	idx = []
	a = soup.find_all('div', attrs={"class":"panel-pane pane-highwire-panel-tabs-container article__body"})[0].text
	header=soup.find_all('div', attrs={"class":"highwire-cite-title"})[0].text
	...
	x=re.sub(r'\xe2\x80\x93', '', x)
	x=re.sub(r'\xe2\x80\x99', '', x)
